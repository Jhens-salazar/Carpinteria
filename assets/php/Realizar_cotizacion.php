...
<head>
    ...
    <title>Cotización de Muebles</title>
    <link rel="stylesheet" href="./assets/css/Realizar_cotizacion.css">
</head>
...
<body>
    ...
    <div class="cont">
        ...
        <form action="/guardar_cotizacion.php" method="post" enctype="multipart/form-data" class="formulario">
